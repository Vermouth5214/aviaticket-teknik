...
class ReportController extends Controller
{
    public function general_report(Request $request)
    {
        ...
        if (isset($_GET['export'])){
            return Excel::download(new GeneralReport($startDate, $endDate, $status, $category, $assignee, $closeby, $overdue, $mode, $user_type, $user_agen), 'General Report.xlsx');
        }
	...
	public function general_report_datatable() {
        ...
        return Datatables::of($data)
            ...
            ->rawColumns(['status','attachment','keterangan','overdue'])
            ->make(true);
	}
