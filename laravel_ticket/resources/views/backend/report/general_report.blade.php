                ...
                <div class="x_content">
                    <form id="form-work" class="form-horizontal" role="form" autocomplete="off" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <select name="closeby" class="form-control">
                                    <?php
                                        $selected = "";
                                        if ($closeby == 999){
                                            $selected = "selected";
...
@section('script')
	...
	<script>
        ...
        $('.dataTable').dataTable({
            processing: true,
            serverSide: true,
            ajax: "<?=url('backend/general-report/datatable?startDate='.$startDate.'&endDate='.$endDate.'&status='.$status.'&mode='.$mode.'&category='.$category.'&assignee='.$assignee.'&closeby='.$closeby.'&overdue='.$overdue.'&user_type='.$user_type.'&user_agen='.$user_agen);?>",
            columns: [
